                ...
                <div class="col-md-6">
                    <div class="mb-3">
                        ...
                        <select class="form-select" id="type" name="type" required>
                            ...
                            <option value="hardware" {{ old('type', $inventory->type) == 'hardware' ? 'selected' : '' }}>Hardware</option>
                            <option value="software" {{ old('type', $inventory->type) == 'software' ? 'selected' : '' }}>Software</option>
                        </select>
                        @error('type')
                            <div class="text-danger">{{ $message }}</div>
                        @enderror
                ...
                <div class="col-md-6">
                    <div class="mb-3">
                        ...
                        <input type="date" class="form-control" id="entry_date" name="entry_date" 
                               value="{{ old('entry_date', $inventory->entry_date->format('Y-m-d')) }}" required>
                        @error('entry_date')
                            <div class="text-danger">{{ $message }}</div>
                        @enderror
                    </div>
                ...
                <div class="col-md-6">
                    <div class="mb-3">
                        ...
                        <input type="number" class="form-control" id="depreciation_years" name="depreciation_years" 
                               value="{{ old('depreciation_years', $inventory->depreciation_years) }}" min="1" max="10" required>
